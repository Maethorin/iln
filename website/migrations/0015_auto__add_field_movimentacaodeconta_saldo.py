...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MovimentacaoDeConta.saldo'
        db.add_column('website_movimentacaodeconta', 'saldo',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'MovimentacaoDeConta.saldo'
        db.delete_column('website_movimentacaodeconta', 'saldo')
