...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Premio.slug'
        db.add_column('website_premio', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=100),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Premio.slug'
        db.delete_column('website_premio', 'slug')
