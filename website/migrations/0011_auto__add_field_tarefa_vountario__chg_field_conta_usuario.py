...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tarefa.vountario'
        db.add_column('website_tarefa', 'vountario',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['website.Conta'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Conta.usuario'
        db.alter_column('website_conta', 'usuario_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
    def backwards(self, orm):
        # Deleting field 'Tarefa.vountario'
        db.delete_column('website_tarefa', 'vountario_id')


        # Changing field 'Conta.usuario'
        db.alter_column('website_conta', 'usuario_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True))
    models = {
        'auth.group': {
