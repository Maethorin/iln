...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Sabor'
        db.create_table('website_sabor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nome', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=120)),
        ))
        db.send_create_signal('website', ['Sabor'])

        # Adding model 'Cor'
        db.create_table('website_cor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nome', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=120)),
        ))
        db.send_create_signal('website', ['Cor'])

        # Adding model 'Tamanho'
        db.create_table('website_tamanho', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nome', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=120)),
        ))
        db.send_create_signal('website', ['Tamanho'])

    def backwards(self, orm):
        # Deleting model 'Sabor'
        db.delete_table('website_sabor')

        # Deleting model 'Cor'
        db.delete_table('website_cor')

        # Deleting model 'Tamanho'
        db.delete_table('website_tamanho')
