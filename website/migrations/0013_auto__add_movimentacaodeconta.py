...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MovimentacaoDeConta'
        db.create_table('website_movimentacaodeconta', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('conta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Conta'])),
            ...
            ('resgate', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['website.Resgate'], null=True, blank=True)),
            ('tarefa', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['website.Tarefa'], null=True, blank=True)),
        ))
        db.send_create_signal('website', ['MovimentacaoDeConta'])

    def backwards(self, orm):
        # Deleting model 'MovimentacaoDeConta'
        db.delete_table('website_movimentacaodeconta')
