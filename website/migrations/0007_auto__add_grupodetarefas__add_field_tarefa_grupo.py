...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GrupoDeTarefas'
        db.create_table('website_grupodetarefas', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nome', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=120)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=100)),
        ))
        db.send_create_signal('website', ['GrupoDeTarefas'])

        # Adding field 'Tarefa.grupo'
        db.add_column('website_tarefa', 'grupo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.GrupoDeTarefas'], null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'GrupoDeTarefas'
        db.delete_table('website_grupodetarefas')

        # Deleting field 'Tarefa.grupo'
        db.delete_column('website_tarefa', 'grupo_id')
